...
class TestFlaskApi(unittest.TestCase):
    ...
    def test_delete_success(self):
        ...
        self.assertNotEqual(response_update, None)
        self.assertEqual(deleted_data, None)
    ...
    def test_create(self):
        ...
        "&mname=mname&email=test@gmail.com&dob=200-2-3&gender=Male&status=1&terms=12&date_accepted=12-1-2"
                                            "&street=214 M street&state=NY&zip=10535&phone=456 543 2345")
        newCount= app.patients.get_count()
        print(newCount-prev_count)
    ...
    def test_server_reponse(self):
        start = time.clock()
        response = self.app.post(BASE_URL + "/patient/new?fname=fname&lname=lname&"
        "&mname=mname&email=tets2t@gmail.com&dob=200-2-3&gender=Male&status=1&terms=12&date_accepted=12-1-2"
                                            "&street=214 M street&state=NY&zip=10535&phone=456 543 2345")
